use crate::{
    BaseOperations, ControlArgument, ControlCommand, ControlDirection, DirectBaseOperations,
    MountOperations, Result, Size,
};

pub const GET_BLOCK_SIZE: ControlCommand =
    ControlCommand::new::<usize>(ControlDirection::READ, b'B', 0);
pub const GET_BLOCK_COUNT: ControlCommand =
    ControlCommand::new::<Size>(ControlDirection::READ, b'B', 1);
