...
use super::{ColorARGB8888, ColorRGB565, ColorRGBA8888};

#[derive(Clone, Copy, PartialEq, Eq)]
#[repr(transparent)]
pub struct ColorBGRA8888(u32);

impl Debug for ColorBGRA8888 {
    fn fmt(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        formatter
            .debug_struct("Color_BGRA8888_type")
...
impl ColorBGRA8888 {
    ...
    pub const fn from_rgba8888(value: ColorRGBA8888) -> Self {
        Self::new(
            value.get_blue(),
            value.get_green(),
            value.get_red(),
...
impl From<ColorBGRA8888> for u32 {
    fn from(value: ColorBGRA8888) -> u32 {
        value.0
    }
}

impl From<u32> for ColorBGRA8888 {
    fn from(value: u32) -> Self {
        Self(value)
    }
}

impl From<ColorARGB8888> for ColorBGRA8888 {
...
impl From<ColorRGBA8888> for ColorBGRA8888 {
...
impl From<ColorRGB565> for ColorBGRA8888 {
...
mod tests {
    ...
    #[test]
    fn test_bgra8888() {
        let color = ColorBGRA8888::new(255, 255, 255, 255);
        ...
        let color = ColorBGRA8888::new(255, 0, 0, 0);
        assert_eq!(color.get_blue(), 0xFF);
        ...
        let color = ColorBGRA8888::new(0, 255, 0, 0);
        ...
        let color = ColorBGRA8888::new(0, 0, 255, 0);
        assert_eq!(color.get_blue(), 0);
        assert_eq!(color.get_green(), 0);
        assert_eq!(color.get_red(), 0xFF);
        assert_eq!(color.get_alpha(), 0);
        ...
        let color = ColorBGRA8888::new(0, 0, 0, 255);
        assert_eq!(color.get_blue(), 0);
        assert_eq!(color.get_green(), 0);
        assert_eq!(color.get_red(), 0);
        assert_eq!(color.get_alpha(), 0xFF);
        ...
        let color = ColorBGRA8888::new(0, 0, 0, 0);
        assert_eq!(color.get_blue(), 0);
        assert_eq!(color.get_green(), 0);
        assert_eq!(color.get_red(), 0);
        assert_eq!(color.get_alpha(), 0);
