...
File_system_result_type Rust_function Xila_get_file_statistics(Xile_file_system_file_identifier_type Handle, Xila_file_system_statistics_type *Buffer);
...
File_system_result_type Rust_function Xila_synchronize_file_data(Xile_file_system_file_identifier_type Handle, bool metadata);
File_system_result_type Rust_function Xila_file_system_open(const char *Path, Xila_file_system_mode_type Mode, Xila_file_system_open_type Open, Xila_file_system_status_type Status, Xile_file_system_file_identifier_type *Handle);
File_system_result_type Rust_function Xila_file_system_open_at(Xile_file_system_file_identifier_type Handle, const char *Path, Xila_file_system_mode_type Mode, Xila_file_system_open_type Open, Xila_file_system_status_type Status,  Xile_file_system_file_identifier_type *New_handle);
...
File_system_result_type Rust_function Xila_read_link_at(Xile_file_system_file_identifier_type handle, const char *Path, char *Buffer, size_t Buffer_size, size_t *Buffer_used);
...
File_system_result_type Rust_function Xila_create_directory(Xile_file_system_file_identifier_type Handle, const char *Path);
File_system_result_type Rust_function Xila_create_directory_at(Xile_file_system_file_identifier_type Handle, const char *Path);
File_system_result_type Rust_function Xila_rename_at(Xile_file_system_file_identifier_type Old_handle, const char *Old_path, Xile_file_system_file_identifier_type New_handle, const char *New_path);
...
File_system_result_type Rust_function Xila_set_position(Xile_file_system_file_identifier_type Handle, __wasi_filedelta_t Offset, __wasi_whence_t Whence, __wasi_filesize_t *New_offset);
...
File_system_result_type Rust_function Xila_file_system_is_terminal(Xile_file_system_file_identifier_type Handle);
File_system_result_type Rust_function Xila_open_directory(Xile_file_system_file_identifier_type Handle, os_dir_stream *Dir_stream);
